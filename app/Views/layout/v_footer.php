<!-- Footer -->
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-md-4">
          ...
          <img src="../assetsfrontend/img/logos/Logo Endless.png" alt="Probolinggo" width="150" height="90">
          </ul>
        </div>
      </div>
    </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                <!-- Project Details Go Here -->
                <h1 class="text-uppercase">SMART SOCIETY</h1>
                <p class="item-intro text-muted">Kabupaten Probolinggo</p>
                <img class="img-fluid d-block mx-auto" src="../assetsfrontend/img/logos/SOCIETY.png" alt="">
  ...
  <script src="../assetsfrontend/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

  <!-- Plugin JavaScript -->
  <script src="../assetsfrontend/vendor/jquery-easing/jquery.easing.min.js"></script>

  <!-- Contact form JavaScript -->
  <script src="../assetsfrontend/js/jqBootstrapValidation.js"></script>
  <script src="../assetsfrontend/js/contact_me.js"></script>

  <!-- Custom scripts for this template -->
  <script src="../assetsfrontend/js/agency.min.js"></script>
