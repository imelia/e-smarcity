                ...
                <div class="p-5">
                  ...
                  <form class="user" action="/login/auth" method="post">
                    <div class="form-group">
                      <input type="email" name="email" class="form-control form-control-user" id="InputForEmail" aria-describedby="emailHelp" placeholder="Masukkan Alamat Email" value="<?= set_value('email')?>">
                    </div>
                    <div class="form-group">
